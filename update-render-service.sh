...
echo "🔄 Обновление настроек сервиса Render"
echo "===================================="
...
echo ""
echo "📊 После обновления настроек:"
echo "- Проверьте логи: render logs -r $SERVICE_ID --tail"
echo "- Проверьте health: curl https://aeon-admin-hr.onrender.com/health"
echo "- Откройте приложение: https://aeon-admin-hr.onrender.com" 