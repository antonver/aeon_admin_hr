...
# Принудительно обновляем статические файлы фронтенда
echo "📋 Принудительно обновляем статические файлы фронтенда..."
if [ -d "frontend/build" ]; then
    echo "🧹 Полностью очищаем старые статические файлы..."
    ...
    echo "Cache bust: $(date +%s)" >> backend/static/.build-timestamp
