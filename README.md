...
### 🔐 Система ожидающих администраторов

Теперь вы можете добавлять администраторов до их первого входа в приложение:

- **Добавление ожидающих админов**: Введите username пользователя, и он будет добавлен в список ожидающих
- **Автоматическое назначение**: При первом входе пользователь автоматически станет администратором
- **Безопасность**: Только администраторы имеют доступ к приложению
- **Управление**: Просматривайте и удаляйте ожидающих администраторов

📖 Подробнее: [Руководство по системе ожидающих администраторов](PENDING_ADMINS_GUIDE.md)
